...
class AuxClassifier(nn.Module):
    ...
    def __init__(self, in_channels, num_classes, pivot_index=0):
        ...
        if pivot_index < 9:
            ...
            size = 8 * 8
        self.fc = nn.Linear(in_features=in_channels * size,
...
class AuxTrainer(object):
    ...
    def _network_split(self):
        ...
        for i in range(len(self.segments) - 1):
            ...
            self.auxfc.append(AuxClassifier(
                ...
                pivot_index=self.settings.pivotSet[i]),
                )
        ...
        for i in range(len(self.segments)):
            ...
            temp_seg_optim = torch.optim.SGD(
                [{'params': self.segments[i].parameters(),
    ...
    def forward(self, images, labels=None):
        ...
        for i in range(len(self.segments)):
            ...
            temp_input = Variable(temp_output.data)
